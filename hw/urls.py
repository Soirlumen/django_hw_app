...
urlpatterns = [
    ...
    path("my-comments/", reviewer_list_view, name="student_comment_list"),
    path("my-comments/<int:pk>/", reviewer_form_view, name="reviewer_form"),
